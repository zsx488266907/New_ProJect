...
public class ItemTwoAdapter extends RecyclerView.Adapter<ItemTwoAdapter.MyVh> {
    private Context context;
    private List<ProductBean.ProductItemBean.ProductItem> commodityList ;
    public ItemTwoAdapter(Context context, List<ProductBean.ProductItemBean.ProductItem> commodityList) {
    ...
    public MyVh onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.twoitem_layout,viewGroup,false);
